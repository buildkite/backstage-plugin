...
The plugin can track deployments across your Buildkite pipelines. There are two ways to mark a build as a deployment:
...
### 2. Using environment-specific deployment flags
